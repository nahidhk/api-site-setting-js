...
document.getElementById('api-found').style="color: #fff;background-color:#343754A1; height: 50px;width: 50px;border-radius: 6px; position: fixed; top: 30%;left: 0;z-index: 10000;opacity: 0.5;";
}
